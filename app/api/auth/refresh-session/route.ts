  ...
  try {
    ...
    switch (role) {
      case "estudante":
        ...
        nome = estudante?.nome_completo || usuarioEstudante?.nome_usuario || ""
      ...
      case "orientador":
        ...
        nome = orientador?.nome_completo || usuarioOrientador?.nome_usuario || ""
      ...
      case "recepcionista":
        ...
        nome = recepcionista?.nome_completo || usuarioRecepcionista?.nome_usuario || ""
      ...
      case "admin":
        ...
        nome = admin?.nome_completo || usuarioAdmin?.nome_usuario || ""
    ...
    // Retornar os dados atualizados para que o cliente possa atualizar a sessão
