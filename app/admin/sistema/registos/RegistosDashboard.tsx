  ...
  return (
    <DashboardLayout navItems={adminNavItems} title="Registos Lectivo" subtitle="Histórico de snapshots de rematrícula">
      ...
      <form onSubmit={handleSearch} style={{ display: "flex", gap: "12px", marginBottom: "20px", flexWrap: "wrap", alignItems: "flex-end" }}>
        <div>
          <label style={{ display: "block", fontSize: "11px", color: "#555e78", marginBottom: "4px" }}>Pesquisar</label>
          <input
            type="text"
        ...
        <div>
          <label style={{ display: "block", fontSize: "11px", color: "#555e78", marginBottom: "4px" }}>Curso</label>
        ...
        <div>
          <label style={{ display: "block", fontSize: "11px", color: "#555e78", marginBottom: "4px" }}>Turno</label>
        ...
        <div>
          <label style={{ display: "block", fontSize: "11px", color: "#555e78", marginBottom: "4px" }}>Ano Lectivo</label>
      ...
      {loading ? (
        <div style={{ textAlign: "center", color: "#555e78", padding: "60px" }}>A carregar registos...</div>
      ) : registos.length === 0 ? (
        ...
        <>
          {/* Summary bar */}
          <div style={{ marginBottom: "16px", fontSize: "13px", color: "#9098b0" }}>
                ...
                >
                  <div style={{ flex: 1 }}>
                    <div style={{ fontSize: "15px", fontWeight: "600", color: "#e8eaf0" }}>
                      ...
                      <span style={{ fontSize: "12px", color: "#555e78", marginLeft: "8px" }}>
                        {r.estudante.numero_estudante}
                      </span>
                    </div>
                    <div style={{ fontSize: "12px", color: "#9098b0", marginTop: "4px" }}>
                  ...
                  <div style={{ color: isExpanded ? "#3b82f6" : "#555e78", fontSize: "20px", transition: "transform 0.2s", transform: isExpanded ? "rotate(180deg)" : "none" }}>
                    ▼
                  </div>
                </div>
                      ...
                      <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "11px", marginTop: "12px" }}>
                        <thead>
                          <tr style={{ borderBottom: "1px solid rgba(255,255,255,0.07)" }}>
                            <th style={{ textAlign: "left", padding: "8px 6px", color: "#555e78" }}>Disciplina</th>
                            <th style={{ textAlign: "center", padding: "8px 6px", color: "#555e78" }}>Sem</th>
                            <th style={{ textAlign: "center", padding: "8px 6px", color: "#555e78" }}>Ano</th>
                            <th style={{ textAlign: "center", padding: "8px 6px", color: "#555e78" }}>AC1</th>
                            <th style={{ textAlign: "center", padding: "8px 6px", color: "#555e78" }}>AC2</th>
                            <th style={{ textAlign: "center", padding: "8px 6px", color: "#555e78" }}>AC3</th>
                            <th style={{ textAlign: "center", padding: "8px 6px", color: "#555e78" }}>TTP</th>
                            <th style={{ textAlign: "center", padding: "8px 6px", color: "#555e78" }}>PP1</th>
                            <th style={{ textAlign: "center", padding: "8px 6px", color: "#555e78" }}>PP2</th>
                            <th style={{ textAlign: "center", padding: "8px 6px", color: "#555e78" }}>Exame</th>
                            <th style={{ textAlign: "center", padding: "8px 6px", color: "#555e78" }}>Rec</th>
                            <th style={{ textAlign: "center", padding: "8px 6px", color: "#555e78" }}>Ex.Esp</th>
                            <th style={{ textAlign: "center", padding: "8px 6px", color: "#555e78" }}>Final</th>
                            <th style={{ textAlign: "center", padding: "8px 6px", color: "#555e78" }}>Disp</th>
                            <th style={{ textAlign: "center", padding: "8px 6px", color: "#555e78" }}>Limiar</th>
                          </tr>
                        </thead>
                        <tbody>
                          {r.notas_snapshot.map((n: NotaSnapshot) => {
                            ...
                            return (
                              <tr key={n.codigo_disciplina} style={{ borderBottom: "1px solid rgba(255,255,255,0.04)", background: failed ? "rgba(224,61,61,0.06)" : "transparent" }}>
                                ...
                                <td style={{ textAlign: "center", padding: "6px", color: "#9098b0" }}>{n.semestre}</td>
                                <td style={{ textAlign: "center", padding: "6px", color: "#9098b0" }}>{n.ano_curricular}º</td>
                                <td style={{ textAlign: "center", padding: "6px", color: "#9098b0" }}>{formatValor(n.ac1)}</td>
                                <td style={{ textAlign: "center", padding: "6px", color: "#9098b0" }}>{formatValor(n.ac2)}</td>
                                <td style={{ textAlign: "center", padding: "6px", color: "#9098b0" }}>{formatValor(n.ac3)}</td>
                                <td style={{ textAlign: "center", padding: "6px", color: "#9098b0" }}>{formatValor(n.ttp)}</td>
                                <td style={{ textAlign: "center", padding: "6px", color: "#9098b0" }}>{formatValor(n.pp1)}</td>
                                <td style={{ textAlign: "center", padding: "6px", color: "#9098b0" }}>{formatValor(n.pp2)}</td>
                                <td style={{ textAlign: "center", padding: "6px", color: "#9098b0" }}>{formatValor(n.exame)}</td>
                                <td style={{ textAlign: "center", padding: "6px", color: "#9098b0" }}>{formatValor(n.recurso)}</td>
                                <td style={{ textAlign: "center", padding: "6px", color: "#9098b0" }}>{formatValor(n.exame_especial)}</td>
                                ...
                                <td style={{ textAlign: "center", padding: "6px", color: n.dispensada ? "#22c55e" : "#555e78" }}>
                                  {n.dispensada ? "Sim" : "Não"}
                                </td>
                                <td style={{ textAlign: "center", padding: "6px", color: "#555e78" }}>
              ...
              {Array.from({ length: pagination.totalPages }, (_, i) => i + 1).map((pg) => (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "6px",
                    color: pg === pagination.page ? "white" : "#9098b0",
                    fontSize: "13px",
                    cursor: "pointer",
                  }}
                >
